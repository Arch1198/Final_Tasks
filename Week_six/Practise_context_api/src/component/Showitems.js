...
import CartContextProviderDelete from "../contexts/CartContextProviderdl";
...
const ShowItem = (props) => {
 ...
 useEffect(()=>{
  ...
  <div className="card-body" style={{display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column"}}>
    <NavLink activeClassName="active"  to="/admin/archana11@gmail.com">
